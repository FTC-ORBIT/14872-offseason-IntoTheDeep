...
public class DriveTrainTankTest extends LinearOpMode {
        ...
        while (!isStopRequested()) {
            ...
            switch (state) {
                case 0:
                    ...
                    break;
                case 1:
                    DriveTrainTank.testMotors(gamepad1, telemetry);
                    test = "test Motors";
                    break;
                case 2:
                    DriveTrainTank.testEncoder(telemetry);
                    test = "test encoders";
                    break;
                case 3:
                    DriveTrainTank.testDeadWheels(telemetry);
                ...
                case 4:
                    ...
                    DriveTrainTank.operate(-leftStick.y,gamepad1.right_trigger,gamepad1.left_trigger,telemetry,gamepad1);
                    test = "drive";
                    break;
            }
